...
export UP_RAILS_ENV=development
...
# Run app
docker run -d -e DATABASE_NAME=$UP_DATABASE_NAME -e RAILS_ENV=$UP_RAILS_ENV -e SECRET_KEY_BASE=175f91804d528c8abb9d6a45066dd50c9cc22ed9344825745500c453108c0fce4eac8f899cedb467eb5dc7f2bab91540a3cc852b55a2d64e0a51e7ca3774bfe8 -p 3000:8080 -v $PWD:/opt/app --link database:db dangerous/rails-dev-postgres
